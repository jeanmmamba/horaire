    ...
    <a href="{{ url('/back/employe/create') }}" class="btn btn-primary pull-right">Create</a>            
                        </div>
                        <div class="card-body">
                    ...
                    <tbody>
                        ...
                        @if($row->type===1)
                            {{ Form::submit('en conger',['class'=>'btn btn-info']) }}
                        @else
                            {{ Form::submit('pas en conger',['class'=>'btn btn-success']) }}
                        @endif
                        {{ Form::close() }}
                    </td>
